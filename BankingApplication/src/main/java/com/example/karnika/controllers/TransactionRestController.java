...
import com.example.karnika.constants.ACTION;
import com.example.karnika.dto.*;
import com.example.karnika.models.Account;
import com.example.karnika.services.AccountService;
import com.example.karnika.services.TransactionService;

import javax.validation.Valid;

import static com.example.karnika.constants.constants.*;
    ...
    public ResponseEntity<?> withdraw(
        ...
        if (InputValidator.isSearchCriteriaValid(withdrawInput)) {
            ...
            Account account = accountService.getAccount(
                    withdrawInput.getpassCode(), withdrawInput.getAccountNumber());
